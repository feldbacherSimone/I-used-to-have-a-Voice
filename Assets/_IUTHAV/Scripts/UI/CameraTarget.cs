...
public class CameraTarget : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        playerInputAction.BaseActionMap.Enable();
        mouseMovement = playerInputAction.BaseActionMap.MousePosition;
        mouseScroll = playerInputAction.BaseActionMap.MouseScroll;
    ...
    void moveCameraTarget()
    {
        ...
        Vector3 newPos = new Vector3(initPos.x + realitveMouseX * strength, initPos.y + realitveMouseY * strength, initPos.z);
